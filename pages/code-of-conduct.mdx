...
_We have a page, [The CTC Way](/the-ctc-way), where we offer guidelines on how to interact in a non-exclusionary way._
...
- ✅ I don't like Emacs keybindings. I prefer to use Vim.
- 🔴 At this point, I genuinely think You're an idiot if you use Rust! It's an overhyped language with no future.
